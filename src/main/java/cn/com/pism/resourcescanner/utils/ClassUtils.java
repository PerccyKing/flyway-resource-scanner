 ...
 */
package cn.com.pism.resourcescanner.utils;


import cn.com.pism.resourcescanner.exception.ScannerException;
...
public class ClassUtils {
     ...
     * @throws ScannerException Thrown when the instantiation failed.
     */
    ...
    public static synchronized <T> T instantiate(String className, ClassLoader classLoader) {
        try {
            ...
            throw new ScannerException("Unable to instantiate class " + className + " : " + e.getMessage(), e);
        }
    }
    ...
    public static synchronized <T> T instantiate(Class<T> clazz) {
        try {
            ...
            throw new ScannerException("Unable to instantiate class " + clazz.getName() + " : " + e.getMessage(), e);
        }
    }
    ...
    public static ClassLoader addJarsOrDirectoriesToClasspath(ClassLoader classLoader, List<File> jarFiles) {
        ...
        for (File jarFile : jarFiles) {
            ...
            try {
                ...
                throw new ScannerException("Unable to load " + jarFile.getPath(), e);
            }
        }
    ...
    public static String getStaticFieldValue(String className, String fieldName, ClassLoader classLoader) {
        try {
            ...
            throw new ScannerException("Unable to obtain field value " + className + "." + fieldName + " : " + e.getMessage(), e);
        }
    }
}